...
<title>Google Cloud Platform — Security Assessment Report</title>
<style>
...
<div class="container">
  ...
  <div class="footer">
    Google Cloud Platform Security Scanner &middot; Generated {html.escape(self.meta.get('scan_time', '')[:19])} &middot;
